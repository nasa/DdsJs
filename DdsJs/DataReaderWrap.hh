...
protected:
	...
	static void New(::v8::FunctionCallbackInfo< ::v8::Value > const& args)
	{
		...
		{
			args.This()->Set(ctx, ::v8::Local< ::v8::String >::New(isolate, DataReaderWrap::subscriberFieldName), args[0]);
			::DDS::Subscriber *sub = reinterpret_cast< ::DDS::Subscriber* >(args[0]->ToObject()->GetAlignedPointerFromInternalField(1));
			args.This()->Set(ctx, ::v8::Local< ::v8::String >::New(isolate, DataReaderWrap::topicFieldName), args[1]);
			::DDS::TopicDescription *topic = reinterpret_cast< ::DDS::TopicDescription* >(args[1]->ToObject()->GetAlignedPointerFromInternalField(1));

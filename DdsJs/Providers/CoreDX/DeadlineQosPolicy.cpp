...
{
    jsValOut.Set(DeadlineQosPolicyProxy::PeriodField::NAME, DeadlineQosPolicyProxy::PeriodField::Proxy::NewInstance(env, cppVal.period));
}
...
{
    DeadlineQosPolicyProxy::PeriodField::Proxy::FromJs(env, jsVal.Get(DeadlineQosPolicyProxy::PeriodField::NAME).As< DeadlineQosPolicyProxy::PeriodField::Proxy::NapiContainer >(), cppValOut.period);
}

...
{
    jsValOut.Set(LifespanQosPolicyProxy::DurationField::NAME, LifespanQosPolicyProxy::DurationField::Proxy::NewInstance(env, cppVal.duration));
}
...
{
    LifespanQosPolicyProxy::DurationField::Proxy::FromJs(env, jsVal.Get(LifespanQosPolicyProxy::DurationField::NAME).As< LifespanQosPolicyProxy::DurationField::Proxy::NapiContainer >(), cppValOut.duration);
}

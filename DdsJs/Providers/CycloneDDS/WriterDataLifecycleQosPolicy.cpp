/**
 * \file CycloneDDS/WriterDataLifecycleQosPolicy.cpp
...
{
    WriterDataLifecycleQosPolicyProxy::AutodisposeUnregisteredInstancesField::Proxy::CppEntity autodispose_unregistered_instances;

    if (!dds_qget_writer_data_lifecycle(cppVal, &autodispose_unregistered_instances))
    {
        throw Napi::Error::New(env, "Internal error: Could not retrieve Writer Data Lifecycle QoS policy information.");
    }

    jsValOut.Set(WriterDataLifecycleQosPolicyProxy::AutodisposeUnregisteredInstancesField::NAME, WriterDataLifecycleQosPolicyProxy::AutodisposeUnregisteredInstancesField::Proxy::NewInstance(env, autodispose_unregistered_instances));
}

...
{
    ReaderDataLifecycleQosPolicyProxy::AutopurgeNowriterSamplesDelayField::Proxy::CppEntity autopurge_nowriter_samples_delay;
    ReaderDataLifecycleQosPolicyProxy::AutopurgeDisposedSamplesDelayField::Proxy::CppEntity autopurge_disposed_samples_delay;

    if (!dds_qget_reader_data_lifecycle(cppVal, &autopurge_nowriter_samples_delay, &autopurge_disposed_samples_delay))
    {
        throw Napi::Error::New(env, "Internal error: Could not retrieve Reader Data Lifecycle QoS policy information.");
    }

    jsValOut.Set(ReaderDataLifecycleQosPolicyProxy::AutopurgeNowriterSamplesDelayField::NAME, ReaderDataLifecycleQosPolicyProxy::AutopurgeNowriterSamplesDelayField::Proxy::NewInstance(env, autopurge_nowriter_samples_delay));
    jsValOut.Set(ReaderDataLifecycleQosPolicyProxy::AutopurgeDisposedSamplesDelayField::NAME, ReaderDataLifecycleQosPolicyProxy::AutopurgeDisposedSamplesDelayField::Proxy::NewInstance(env, autopurge_disposed_samples_delay));
}
...
ReaderDataLifecycleQosPolicyProxy::FromJs(Napi::Env env, NapiContainer const& jsVal, CppEntity& cppValOut)
{
    ...
    ReaderDataLifecycleQosPolicyProxy::AutopurgeNowriterSamplesDelayField::Proxy::FromJs(env, jsVal.Get(ReaderDataLifecycleQosPolicyProxy::AutopurgeNowriterSamplesDelayField::NAME).As< ReaderDataLifecycleQosPolicyProxy::AutopurgeNowriterSamplesDelayField::Proxy::NapiContainer >(), autopurge_nowriter_samples_delay);
    ReaderDataLifecycleQosPolicyProxy::AutopurgeDisposedSamplesDelayField::Proxy::FromJs(env, jsVal.Get(ReaderDataLifecycleQosPolicyProxy::AutopurgeDisposedSamplesDelayField::NAME).As< ReaderDataLifecycleQosPolicyProxy::AutopurgeDisposedSamplesDelayField::Proxy::NapiContainer >(), autopurge_disposed_samples_delay);

    dds_qset_reader_data_lifecycle(cppValOut, autopurge_nowriter_samples_delay, autopurge_disposed_samples_delay);
}

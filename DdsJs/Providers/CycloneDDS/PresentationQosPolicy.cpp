...
{
    typename PresentationQosPolicyProxy::AccessScopeField::Proxy::CppEntity access_scope;
    typename PresentationQosPolicyProxy::CoherentAccessField::Proxy::CppEntity coherent_access;
    typename PresentationQosPolicyProxy::OrderedAccessField::Proxy::CppEntity ordered_access;

    if (!dds_qget_presentation(cppVal, &access_scope, &coherent_access, &ordered_access))
    {
        throw Napi::Error::New(env, "Internal error: Could not retrieve Presentation QoS policy.");
    }

    jsValOut.Set(PresentationQosPolicyProxy::AccessScopeField::NAME, PresentationQosPolicyProxy::AccessScopeField::Proxy::NewInstance(env, access_scope));
    jsValOut.Set(PresentationQosPolicyProxy::CoherentAccessField::NAME, PresentationQosPolicyProxy::CoherentAccessField::Proxy::NewInstance(env, coherent_access));
    jsValOut.Set(PresentationQosPolicyProxy::OrderedAccessField::NAME, PresentationQosPolicyProxy::OrderedAccessField::Proxy::NewInstance(env, ordered_access));
}
...
PresentationQosPolicyProxy::FromJs(Napi::Env env, NapiContainer const& jsVal, CppEntity& cppValOut)
{
    ...
    PresentationQosPolicyProxy::AccessScopeField::Proxy::FromJs(env, jsVal.Get(PresentationQosPolicyProxy::AccessScopeField::NAME).As< PresentationQosPolicyProxy::AccessScopeField::Proxy::NapiContainer >(), access_scope);
    PresentationQosPolicyProxy::CoherentAccessField::Proxy::FromJs(env, jsVal.Get(PresentationQosPolicyProxy::CoherentAccessField::NAME).As< PresentationQosPolicyProxy::CoherentAccessField::Proxy::NapiContainer >(), coherent_access);
    PresentationQosPolicyProxy::OrderedAccessField::Proxy::FromJs(env, jsVal.Get(PresentationQosPolicyProxy::OrderedAccessField::NAME).As< PresentationQosPolicyProxy::OrderedAccessField::Proxy::NapiContainer >(), ordered_access);

    dds_qset_presentation(cppValOut, access_scope, coherent_access, ordered_access);
}

...
// Generated on: July 29, 2022 at 4:23:32 PM GMT
// ----------------------------------------------------------------------------
...
void RequestedIncompatibleQosStatusField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "RequestedIncompatibleQosStatusField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void ParticipantBuiltinTopicDataField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "ParticipantBuiltinTopicDataField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void WriterDataLifecycleQosPolicyField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "WriterDataLifecycleQosPolicyField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void PublicationBuiltinTopicDataField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "PublicationBuiltinTopicDataField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void DestinationOrderQosPolicyField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "DestinationOrderQosPolicyField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void SubscriptionBuiltinTopicDataField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "SubscriptionBuiltinTopicDataField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void DurabilityServiceQosPolicyField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "DurabilityServiceQosPolicyField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void RequestedDeadlineMissedStatusField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "RequestedDeadlineMissedStatusField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void DomainParticipantFactoryQosField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "DomainParticipantFactoryQosField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void SubscriptionMatchedStatusField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "SubscriptionMatchedStatusField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void ReaderDataLifecycleQosPolicyField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "ReaderDataLifecycleQosPolicyField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void OfferedIncompatibleQosStatusField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "OfferedIncompatibleQosStatusField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void OwnershipStrengthQosPolicyField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "OwnershipStrengthQosPolicyField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void OfferedDeadlineMissedStatusField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "OfferedDeadlineMissedStatusField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,
...
void TransportPriorityQosPolicyField::Init(Local<Object> exports)
{
	...
	if (!setResult.FromJust())
	{
		...
		errMsg
			<< "Could not set constructor function for "
			<< "TransportPriorityQosPolicyField.";
		isolate->ThrowException(
			Exception::TypeError(
				String::NewFromUtf8(
					isolate,

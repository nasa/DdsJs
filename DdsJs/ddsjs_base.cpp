...
// Generated on: February 20, 2019 8:44:06 PM GMT
// ----------------------------------------------------------------------------
...
void PresentationQosPolicyAccessScopeKindField::Init(Local<Object> exports)
{
	...
	exports->Set(ctx, String::NewFromUtf8(isolate, "PresentationQosPolicyAccessScopeKind"), enumObj);
}
...
void HistoryQosPolicyKindField::Init(Local<Object> exports)
{
	...
	exports->Set(ctx, String::NewFromUtf8(isolate, "HistoryQosPolicyKind"), enumObj);
}
...
void DestinationOrderQosPolicyKindField::Init(Local<Object> exports)
{
	...
	exports->Set(ctx, String::NewFromUtf8(isolate, "DestinationOrderQosPolicyKind"), enumObj);
}
...
void ReliabilityQosPolicyKindField::Init(Local<Object> exports)
{
	...
	exports->Set(ctx, String::NewFromUtf8(isolate, "ReliabilityQosPolicyKind"), enumObj);
}
...
void LivelinessQosPolicyKindField::Init(Local<Object> exports)
{
	...
	exports->Set(ctx, String::NewFromUtf8(isolate, "LivelinessQosPolicyKind"), enumObj);
}
...
void DurabilityQosPolicyKindField::Init(Local<Object> exports)
{
	...
	exports->Set(ctx, String::NewFromUtf8(isolate, "DurabilityQosPolicyKind"), enumObj);
}
...
void SampleRejectedStatusKindField::Init(Local<Object> exports)
{
	...
	exports->Set(ctx, String::NewFromUtf8(isolate, "SampleRejectedStatusKind"), enumObj);
}
...
void OwnershipQosPolicyKindField::Init(Local<Object> exports)
{
	...
	exports->Set(ctx, String::NewFromUtf8(isolate, "OwnershipQosPolicyKind"), enumObj);
}
...
void TimeBasedFilterQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, TimeBasedFilterQosPolicyField::New)->GetFunction());
...
Local<Value> TimeBasedFilterQosPolicyField::FromCppToJsValue(TimeBasedFilterQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, TimeBasedFilterQosPolicyField::minimum_separationFieldName),
		::DDS::Duration_tField::FromCppToJsValue(cppValue.minimum_separation));
...
void DataWriterQosField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, DataWriterQosField::New)->GetFunction());
...
Local<Value> DataWriterQosField::FromCppToJsValue(DataWriterQosField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::durabilityFieldName),
		::DDS::DurabilityQosPolicyField::FromCppToJsValue(cppValue.durability));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::durability_serviceFieldName),
		::DDS::DurabilityServiceQosPolicyField::FromCppToJsValue(cppValue.durability_service));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::deadlineFieldName),
		::DDS::DeadlineQosPolicyField::FromCppToJsValue(cppValue.deadline));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::latency_budgetFieldName),
		::DDS::LatencyBudgetQosPolicyField::FromCppToJsValue(cppValue.latency_budget));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::livelinessFieldName),
		::DDS::LivelinessQosPolicyField::FromCppToJsValue(cppValue.liveliness));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::reliabilityFieldName),
		::DDS::ReliabilityQosPolicyField::FromCppToJsValue(cppValue.reliability));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::destination_orderFieldName),
		::DDS::DestinationOrderQosPolicyField::FromCppToJsValue(cppValue.destination_order));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::historyFieldName),
		::DDS::HistoryQosPolicyField::FromCppToJsValue(cppValue.history));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::resource_limitsFieldName),
		::DDS::ResourceLimitsQosPolicyField::FromCppToJsValue(cppValue.resource_limits));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::transport_priorityFieldName),
		::DDS::TransportPriorityQosPolicyField::FromCppToJsValue(cppValue.transport_priority));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::lifespanFieldName),
		::DDS::LifespanQosPolicyField::FromCppToJsValue(cppValue.lifespan));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::user_dataFieldName),
		::DDS::UserDataQosPolicyField::FromCppToJsValue(cppValue.user_data));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::ownershipFieldName),
		::DDS::OwnershipQosPolicyField::FromCppToJsValue(cppValue.ownership));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::ownership_strengthFieldName),
		::DDS::OwnershipStrengthQosPolicyField::FromCppToJsValue(cppValue.ownership_strength));
	result->Set(ctx,
		Local<String>::New(isolate, DataWriterQosField::writer_data_lifecycleFieldName),
		::DDS::WriterDataLifecycleQosPolicyField::FromCppToJsValue(cppValue.writer_data_lifecycle));
...
void EntityFactoryQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, EntityFactoryQosPolicyField::New)->GetFunction());
...
Local<Value> EntityFactoryQosPolicyField::FromCppToJsValue(EntityFactoryQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, EntityFactoryQosPolicyField::autoenable_created_entitiesFieldName),
		::DdsJs::BooleanField::FromCppToJsValue(cppValue.autoenable_created_entities));
...
void LivelinessChangedStatusField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, LivelinessChangedStatusField::New)->GetFunction());
...
Local<Value> LivelinessChangedStatusField::FromCppToJsValue(LivelinessChangedStatusField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, LivelinessChangedStatusField::alive_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.alive_count));
	result->Set(ctx,
		Local<String>::New(isolate, LivelinessChangedStatusField::not_alive_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.not_alive_count));
	result->Set(ctx,
		Local<String>::New(isolate, LivelinessChangedStatusField::alive_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.alive_count_change));
	result->Set(ctx,
		Local<String>::New(isolate, LivelinessChangedStatusField::not_alive_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.not_alive_count_change));
	result->Set(ctx,
		Local<String>::New(isolate, LivelinessChangedStatusField::last_publication_handleFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.last_publication_handle));
...
void RequestedIncompatibleQosStatusField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, RequestedIncompatibleQosStatusField::New)->GetFunction());
...
Local<Value> RequestedIncompatibleQosStatusField::FromCppToJsValue(RequestedIncompatibleQosStatusField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, RequestedIncompatibleQosStatusField::total_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count));
	result->Set(ctx,
		Local<String>::New(isolate, RequestedIncompatibleQosStatusField::total_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count_change));
	result->Set(ctx,
		Local<String>::New(isolate, RequestedIncompatibleQosStatusField::last_policy_idFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.last_policy_id));
	result->Set(ctx,
		Local<String>::New(isolate, RequestedIncompatibleQosStatusField::policiesFieldName),
		::DdsJs::UnboundedSeqField< ::DDS::QosPolicyCountField >::FromCppToJsValue(cppValue.policies));
...
void ParticipantBuiltinTopicDataField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, ParticipantBuiltinTopicDataField::New)->GetFunction());
...
Local<Value> ParticipantBuiltinTopicDataField::FromCppToJsValue(ParticipantBuiltinTopicDataField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, ParticipantBuiltinTopicDataField::keyFieldName),
		::DDS::BuiltinTopicKey_tField::FromCppToJsValue(cppValue.key));
	result->Set(ctx,
		Local<String>::New(isolate, ParticipantBuiltinTopicDataField::user_dataFieldName),
		::DDS::UserDataQosPolicyField::FromCppToJsValue(cppValue.user_data));
...
void SampleRejectedStatusField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, SampleRejectedStatusField::New)->GetFunction());
...
Local<Value> SampleRejectedStatusField::FromCppToJsValue(SampleRejectedStatusField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, SampleRejectedStatusField::total_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count));
	result->Set(ctx,
		Local<String>::New(isolate, SampleRejectedStatusField::total_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count_change));
	result->Set(ctx,
		Local<String>::New(isolate, SampleRejectedStatusField::last_reasonFieldName),
		::DDS::SampleRejectedStatusKindField::FromCppToJsValue(cppValue.last_reason));
	result->Set(ctx,
		Local<String>::New(isolate, SampleRejectedStatusField::last_instance_handleFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.last_instance_handle));
...
void LatencyBudgetQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, LatencyBudgetQosPolicyField::New)->GetFunction());
...
Local<Value> LatencyBudgetQosPolicyField::FromCppToJsValue(LatencyBudgetQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, LatencyBudgetQosPolicyField::durationFieldName),
		::DDS::Duration_tField::FromCppToJsValue(cppValue.duration));
...
void TopicQosField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, TopicQosField::New)->GetFunction());
...
Local<Value> TopicQosField::FromCppToJsValue(TopicQosField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::topic_dataFieldName),
		::DDS::TopicDataQosPolicyField::FromCppToJsValue(cppValue.topic_data));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::durabilityFieldName),
		::DDS::DurabilityQosPolicyField::FromCppToJsValue(cppValue.durability));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::durability_serviceFieldName),
		::DDS::DurabilityServiceQosPolicyField::FromCppToJsValue(cppValue.durability_service));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::deadlineFieldName),
		::DDS::DeadlineQosPolicyField::FromCppToJsValue(cppValue.deadline));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::latency_budgetFieldName),
		::DDS::LatencyBudgetQosPolicyField::FromCppToJsValue(cppValue.latency_budget));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::livelinessFieldName),
		::DDS::LivelinessQosPolicyField::FromCppToJsValue(cppValue.liveliness));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::reliabilityFieldName),
		::DDS::ReliabilityQosPolicyField::FromCppToJsValue(cppValue.reliability));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::destination_orderFieldName),
		::DDS::DestinationOrderQosPolicyField::FromCppToJsValue(cppValue.destination_order));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::historyFieldName),
		::DDS::HistoryQosPolicyField::FromCppToJsValue(cppValue.history));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::resource_limitsFieldName),
		::DDS::ResourceLimitsQosPolicyField::FromCppToJsValue(cppValue.resource_limits));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::transport_priorityFieldName),
		::DDS::TransportPriorityQosPolicyField::FromCppToJsValue(cppValue.transport_priority));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::lifespanFieldName),
		::DDS::LifespanQosPolicyField::FromCppToJsValue(cppValue.lifespan));
	result->Set(ctx,
		Local<String>::New(isolate, TopicQosField::ownershipFieldName),
		::DDS::OwnershipQosPolicyField::FromCppToJsValue(cppValue.ownership));
...
void SubscriberQosField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, SubscriberQosField::New)->GetFunction());
...
Local<Value> SubscriberQosField::FromCppToJsValue(SubscriberQosField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, SubscriberQosField::presentationFieldName),
		::DDS::PresentationQosPolicyField::FromCppToJsValue(cppValue.presentation));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriberQosField::partitionFieldName),
		::DDS::PartitionQosPolicyField::FromCppToJsValue(cppValue.partition));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriberQosField::group_dataFieldName),
		::DDS::GroupDataQosPolicyField::FromCppToJsValue(cppValue.group_data));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriberQosField::entity_factoryFieldName),
		::DDS::EntityFactoryQosPolicyField::FromCppToJsValue(cppValue.entity_factory));
...
void SampleInfoField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, SampleInfoField::New)->GetFunction());
...
Local<Value> SampleInfoField::FromCppToJsValue(SampleInfoField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, SampleInfoField::sample_stateFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.sample_state));
	result->Set(ctx,
		Local<String>::New(isolate, SampleInfoField::view_stateFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.view_state));
	result->Set(ctx,
		Local<String>::New(isolate, SampleInfoField::instance_stateFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.instance_state));
	result->Set(ctx,
		Local<String>::New(isolate, SampleInfoField::instance_handleFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.instance_handle));
	result->Set(ctx,
		Local<String>::New(isolate, SampleInfoField::publication_handleFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.publication_handle));
	result->Set(ctx,
		Local<String>::New(isolate, SampleInfoField::disposed_generation_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.disposed_generation_count));
	result->Set(ctx,
		Local<String>::New(isolate, SampleInfoField::no_writers_generation_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.no_writers_generation_count));
	result->Set(ctx,
		Local<String>::New(isolate, SampleInfoField::sample_rankFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.sample_rank));
	result->Set(ctx,
		Local<String>::New(isolate, SampleInfoField::generation_rankFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.generation_rank));
	result->Set(ctx,
		Local<String>::New(isolate, SampleInfoField::absolute_generation_rankFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.absolute_generation_rank));
	result->Set(ctx,
		Local<String>::New(isolate, SampleInfoField::valid_dataFieldName),
		::DdsJs::BooleanField::FromCppToJsValue(cppValue.valid_data));
...
void PresentationQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, PresentationQosPolicyField::New)->GetFunction());
...
Local<Value> PresentationQosPolicyField::FromCppToJsValue(PresentationQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, PresentationQosPolicyField::access_scopeFieldName),
		::DDS::PresentationQosPolicyAccessScopeKindField::FromCppToJsValue(cppValue.access_scope));
	result->Set(ctx,
		Local<String>::New(isolate, PresentationQosPolicyField::coherent_accessFieldName),
		::DdsJs::BooleanField::FromCppToJsValue(cppValue.coherent_access));
	result->Set(ctx,
		Local<String>::New(isolate, PresentationQosPolicyField::ordered_accessFieldName),
		::DdsJs::BooleanField::FromCppToJsValue(cppValue.ordered_access));
...
void Duration_tField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, Duration_tField::New)->GetFunction());
...
Local<Value> Duration_tField::FromCppToJsValue(Duration_tField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, Duration_tField::secFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.sec));
	result->Set(ctx,
		Local<String>::New(isolate, Duration_tField::nanosecFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.nanosec));
...
void LivelinessLostStatusField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, LivelinessLostStatusField::New)->GetFunction());
...
Local<Value> LivelinessLostStatusField::FromCppToJsValue(LivelinessLostStatusField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, LivelinessLostStatusField::total_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count));
	result->Set(ctx,
		Local<String>::New(isolate, LivelinessLostStatusField::total_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count_change));
...
void PublisherQosField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, PublisherQosField::New)->GetFunction());
...
Local<Value> PublisherQosField::FromCppToJsValue(PublisherQosField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, PublisherQosField::presentationFieldName),
		::DDS::PresentationQosPolicyField::FromCppToJsValue(cppValue.presentation));
	result->Set(ctx,
		Local<String>::New(isolate, PublisherQosField::partitionFieldName),
		::DDS::PartitionQosPolicyField::FromCppToJsValue(cppValue.partition));
	result->Set(ctx,
		Local<String>::New(isolate, PublisherQosField::group_dataFieldName),
		::DDS::GroupDataQosPolicyField::FromCppToJsValue(cppValue.group_data));
	result->Set(ctx,
		Local<String>::New(isolate, PublisherQosField::entity_factoryFieldName),
		::DDS::EntityFactoryQosPolicyField::FromCppToJsValue(cppValue.entity_factory));
...
void DataReaderQosField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, DataReaderQosField::New)->GetFunction());
...
Local<Value> DataReaderQosField::FromCppToJsValue(DataReaderQosField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::durabilityFieldName),
		::DDS::DurabilityQosPolicyField::FromCppToJsValue(cppValue.durability));
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::deadlineFieldName),
		::DDS::DeadlineQosPolicyField::FromCppToJsValue(cppValue.deadline));
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::latency_budgetFieldName),
		::DDS::LatencyBudgetQosPolicyField::FromCppToJsValue(cppValue.latency_budget));
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::livelinessFieldName),
		::DDS::LivelinessQosPolicyField::FromCppToJsValue(cppValue.liveliness));
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::reliabilityFieldName),
		::DDS::ReliabilityQosPolicyField::FromCppToJsValue(cppValue.reliability));
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::destination_orderFieldName),
		::DDS::DestinationOrderQosPolicyField::FromCppToJsValue(cppValue.destination_order));
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::historyFieldName),
		::DDS::HistoryQosPolicyField::FromCppToJsValue(cppValue.history));
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::resource_limitsFieldName),
		::DDS::ResourceLimitsQosPolicyField::FromCppToJsValue(cppValue.resource_limits));
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::user_dataFieldName),
		::DDS::UserDataQosPolicyField::FromCppToJsValue(cppValue.user_data));
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::ownershipFieldName),
		::DDS::OwnershipQosPolicyField::FromCppToJsValue(cppValue.ownership));
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::time_based_filterFieldName),
		::DDS::TimeBasedFilterQosPolicyField::FromCppToJsValue(cppValue.time_based_filter));
	result->Set(ctx,
		Local<String>::New(isolate, DataReaderQosField::reader_data_lifecycleFieldName),
		::DDS::ReaderDataLifecycleQosPolicyField::FromCppToJsValue(cppValue.reader_data_lifecycle));
...
void DeadlineQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, DeadlineQosPolicyField::New)->GetFunction());
...
Local<Value> DeadlineQosPolicyField::FromCppToJsValue(DeadlineQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, DeadlineQosPolicyField::periodFieldName),
		::DDS::Duration_tField::FromCppToJsValue(cppValue.period));
...
void WriterDataLifecycleQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, WriterDataLifecycleQosPolicyField::New)->GetFunction());
...
Local<Value> WriterDataLifecycleQosPolicyField::FromCppToJsValue(WriterDataLifecycleQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, WriterDataLifecycleQosPolicyField::autodispose_unregistered_instancesFieldName),
		::DdsJs::BooleanField::FromCppToJsValue(cppValue.autodispose_unregistered_instances));
...
void LivelinessQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, LivelinessQosPolicyField::New)->GetFunction());
...
Local<Value> LivelinessQosPolicyField::FromCppToJsValue(LivelinessQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, LivelinessQosPolicyField::kindFieldName),
		::DDS::LivelinessQosPolicyKindField::FromCppToJsValue(cppValue.kind));
	result->Set(ctx,
		Local<String>::New(isolate, LivelinessQosPolicyField::lease_durationFieldName),
		::DDS::Duration_tField::FromCppToJsValue(cppValue.lease_duration));
...
void PublicationBuiltinTopicDataField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, PublicationBuiltinTopicDataField::New)->GetFunction());
...
Local<Value> PublicationBuiltinTopicDataField::FromCppToJsValue(PublicationBuiltinTopicDataField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::keyFieldName),
		::DDS::BuiltinTopicKey_tField::FromCppToJsValue(cppValue.key));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::participant_keyFieldName),
		::DDS::BuiltinTopicKey_tField::FromCppToJsValue(cppValue.participant_key));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::topic_nameFieldName),
		::DdsJs::UnboundedStringField::FromCppToJsValue(cppValue.topic_name));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::type_nameFieldName),
		::DdsJs::UnboundedStringField::FromCppToJsValue(cppValue.type_name));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::durabilityFieldName),
		::DDS::DurabilityQosPolicyField::FromCppToJsValue(cppValue.durability));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::durability_serviceFieldName),
		::DDS::DurabilityServiceQosPolicyField::FromCppToJsValue(cppValue.durability_service));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::deadlineFieldName),
		::DDS::DeadlineQosPolicyField::FromCppToJsValue(cppValue.deadline));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::latency_budgetFieldName),
		::DDS::LatencyBudgetQosPolicyField::FromCppToJsValue(cppValue.latency_budget));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::livelinessFieldName),
		::DDS::LivelinessQosPolicyField::FromCppToJsValue(cppValue.liveliness));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::reliabilityFieldName),
		::DDS::ReliabilityQosPolicyField::FromCppToJsValue(cppValue.reliability));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::lifespanFieldName),
		::DDS::LifespanQosPolicyField::FromCppToJsValue(cppValue.lifespan));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::user_dataFieldName),
		::DDS::UserDataQosPolicyField::FromCppToJsValue(cppValue.user_data));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::ownershipFieldName),
		::DDS::OwnershipQosPolicyField::FromCppToJsValue(cppValue.ownership));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::ownership_strengthFieldName),
		::DDS::OwnershipStrengthQosPolicyField::FromCppToJsValue(cppValue.ownership_strength));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::destination_orderFieldName),
		::DDS::DestinationOrderQosPolicyField::FromCppToJsValue(cppValue.destination_order));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::presentationFieldName),
		::DDS::PresentationQosPolicyField::FromCppToJsValue(cppValue.presentation));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::partitionFieldName),
		::DDS::PartitionQosPolicyField::FromCppToJsValue(cppValue.partition));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::topic_dataFieldName),
		::DDS::TopicDataQosPolicyField::FromCppToJsValue(cppValue.topic_data));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationBuiltinTopicDataField::group_dataFieldName),
		::DDS::GroupDataQosPolicyField::FromCppToJsValue(cppValue.group_data));
...
void DestinationOrderQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, DestinationOrderQosPolicyField::New)->GetFunction());
...
Local<Value> DestinationOrderQosPolicyField::FromCppToJsValue(DestinationOrderQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, DestinationOrderQosPolicyField::kindFieldName),
		::DDS::DestinationOrderQosPolicyKindField::FromCppToJsValue(cppValue.kind));
...
void SubscriptionBuiltinTopicDataField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, SubscriptionBuiltinTopicDataField::New)->GetFunction());
...
Local<Value> SubscriptionBuiltinTopicDataField::FromCppToJsValue(SubscriptionBuiltinTopicDataField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::keyFieldName),
		::DDS::BuiltinTopicKey_tField::FromCppToJsValue(cppValue.key));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::participant_keyFieldName),
		::DDS::BuiltinTopicKey_tField::FromCppToJsValue(cppValue.participant_key));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::topic_nameFieldName),
		::DdsJs::UnboundedStringField::FromCppToJsValue(cppValue.topic_name));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::type_nameFieldName),
		::DdsJs::UnboundedStringField::FromCppToJsValue(cppValue.type_name));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::durabilityFieldName),
		::DDS::DurabilityQosPolicyField::FromCppToJsValue(cppValue.durability));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::deadlineFieldName),
		::DDS::DeadlineQosPolicyField::FromCppToJsValue(cppValue.deadline));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::latency_budgetFieldName),
		::DDS::LatencyBudgetQosPolicyField::FromCppToJsValue(cppValue.latency_budget));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::livelinessFieldName),
		::DDS::LivelinessQosPolicyField::FromCppToJsValue(cppValue.liveliness));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::reliabilityFieldName),
		::DDS::ReliabilityQosPolicyField::FromCppToJsValue(cppValue.reliability));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::ownershipFieldName),
		::DDS::OwnershipQosPolicyField::FromCppToJsValue(cppValue.ownership));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::destination_orderFieldName),
		::DDS::DestinationOrderQosPolicyField::FromCppToJsValue(cppValue.destination_order));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::user_dataFieldName),
		::DDS::UserDataQosPolicyField::FromCppToJsValue(cppValue.user_data));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::time_based_filterFieldName),
		::DDS::TimeBasedFilterQosPolicyField::FromCppToJsValue(cppValue.time_based_filter));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::presentationFieldName),
		::DDS::PresentationQosPolicyField::FromCppToJsValue(cppValue.presentation));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::partitionFieldName),
		::DDS::PartitionQosPolicyField::FromCppToJsValue(cppValue.partition));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::topic_dataFieldName),
		::DDS::TopicDataQosPolicyField::FromCppToJsValue(cppValue.topic_data));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionBuiltinTopicDataField::group_dataFieldName),
		::DDS::GroupDataQosPolicyField::FromCppToJsValue(cppValue.group_data));
...
void DurabilityServiceQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, DurabilityServiceQosPolicyField::New)->GetFunction());
...
Local<Value> DurabilityServiceQosPolicyField::FromCppToJsValue(DurabilityServiceQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, DurabilityServiceQosPolicyField::service_cleanup_delayFieldName),
		::DDS::Duration_tField::FromCppToJsValue(cppValue.service_cleanup_delay));
	result->Set(ctx,
		Local<String>::New(isolate, DurabilityServiceQosPolicyField::history_kindFieldName),
		::DDS::HistoryQosPolicyKindField::FromCppToJsValue(cppValue.history_kind));
	result->Set(ctx,
		Local<String>::New(isolate, DurabilityServiceQosPolicyField::history_depthFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.history_depth));
	result->Set(ctx,
		Local<String>::New(isolate, DurabilityServiceQosPolicyField::max_samplesFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.max_samples));
	result->Set(ctx,
		Local<String>::New(isolate, DurabilityServiceQosPolicyField::max_instancesFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.max_instances));
	result->Set(ctx,
		Local<String>::New(isolate, DurabilityServiceQosPolicyField::max_samples_per_instanceFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.max_samples_per_instance));
...
void SampleLostStatusField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, SampleLostStatusField::New)->GetFunction());
...
Local<Value> SampleLostStatusField::FromCppToJsValue(SampleLostStatusField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, SampleLostStatusField::total_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count));
	result->Set(ctx,
		Local<String>::New(isolate, SampleLostStatusField::total_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count_change));
...
void LifespanQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, LifespanQosPolicyField::New)->GetFunction());
...
Local<Value> LifespanQosPolicyField::FromCppToJsValue(LifespanQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, LifespanQosPolicyField::durationFieldName),
		::DDS::Duration_tField::FromCppToJsValue(cppValue.duration));
...
void OwnershipQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, OwnershipQosPolicyField::New)->GetFunction());
...
Local<Value> OwnershipQosPolicyField::FromCppToJsValue(OwnershipQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, OwnershipQosPolicyField::kindFieldName),
		::DDS::OwnershipQosPolicyKindField::FromCppToJsValue(cppValue.kind));
...
void PublicationMatchedStatusField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, PublicationMatchedStatusField::New)->GetFunction());
...
Local<Value> PublicationMatchedStatusField::FromCppToJsValue(PublicationMatchedStatusField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, PublicationMatchedStatusField::total_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationMatchedStatusField::total_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count_change));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationMatchedStatusField::current_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.current_count));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationMatchedStatusField::current_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.current_count_change));
	result->Set(ctx,
		Local<String>::New(isolate, PublicationMatchedStatusField::last_subscription_handleFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.last_subscription_handle));
...
void ResourceLimitsQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, ResourceLimitsQosPolicyField::New)->GetFunction());
...
Local<Value> ResourceLimitsQosPolicyField::FromCppToJsValue(ResourceLimitsQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, ResourceLimitsQosPolicyField::max_samplesFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.max_samples));
	result->Set(ctx,
		Local<String>::New(isolate, ResourceLimitsQosPolicyField::max_instancesFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.max_instances));
	result->Set(ctx,
		Local<String>::New(isolate, ResourceLimitsQosPolicyField::max_samples_per_instanceFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.max_samples_per_instance));
...
void RequestedDeadlineMissedStatusField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, RequestedDeadlineMissedStatusField::New)->GetFunction());
...
Local<Value> RequestedDeadlineMissedStatusField::FromCppToJsValue(RequestedDeadlineMissedStatusField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, RequestedDeadlineMissedStatusField::total_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count));
	result->Set(ctx,
		Local<String>::New(isolate, RequestedDeadlineMissedStatusField::total_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count_change));
	result->Set(ctx,
		Local<String>::New(isolate, RequestedDeadlineMissedStatusField::last_instance_handleFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.last_instance_handle));
...
void DomainParticipantFactoryQosField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, DomainParticipantFactoryQosField::New)->GetFunction());
...
Local<Value> DomainParticipantFactoryQosField::FromCppToJsValue(DomainParticipantFactoryQosField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, DomainParticipantFactoryQosField::entity_factoryFieldName),
		::DDS::EntityFactoryQosPolicyField::FromCppToJsValue(cppValue.entity_factory));
...
void SubscriptionMatchedStatusField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, SubscriptionMatchedStatusField::New)->GetFunction());
...
Local<Value> SubscriptionMatchedStatusField::FromCppToJsValue(SubscriptionMatchedStatusField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionMatchedStatusField::total_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionMatchedStatusField::total_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count_change));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionMatchedStatusField::current_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.current_count));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionMatchedStatusField::current_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.current_count_change));
	result->Set(ctx,
		Local<String>::New(isolate, SubscriptionMatchedStatusField::last_publication_handleFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.last_publication_handle));
...
void ReliabilityQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, ReliabilityQosPolicyField::New)->GetFunction());
...
Local<Value> ReliabilityQosPolicyField::FromCppToJsValue(ReliabilityQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, ReliabilityQosPolicyField::kindFieldName),
		::DDS::ReliabilityQosPolicyKindField::FromCppToJsValue(cppValue.kind));
	result->Set(ctx,
		Local<String>::New(isolate, ReliabilityQosPolicyField::max_blocking_timeFieldName),
		::DDS::Duration_tField::FromCppToJsValue(cppValue.max_blocking_time));
...
void InconsistentTopicStatusField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, InconsistentTopicStatusField::New)->GetFunction());
...
Local<Value> InconsistentTopicStatusField::FromCppToJsValue(InconsistentTopicStatusField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, InconsistentTopicStatusField::total_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count));
	result->Set(ctx,
		Local<String>::New(isolate, InconsistentTopicStatusField::total_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count_change));
...
void DurabilityQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, DurabilityQosPolicyField::New)->GetFunction());
...
Local<Value> DurabilityQosPolicyField::FromCppToJsValue(DurabilityQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, DurabilityQosPolicyField::kindFieldName),
		::DDS::DurabilityQosPolicyKindField::FromCppToJsValue(cppValue.kind));
...
void ReaderDataLifecycleQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, ReaderDataLifecycleQosPolicyField::New)->GetFunction());
...
Local<Value> ReaderDataLifecycleQosPolicyField::FromCppToJsValue(ReaderDataLifecycleQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, ReaderDataLifecycleQosPolicyField::autopurge_nowriter_samples_delayFieldName),
		::DDS::Duration_tField::FromCppToJsValue(cppValue.autopurge_nowriter_samples_delay));
	result->Set(ctx,
		Local<String>::New(isolate, ReaderDataLifecycleQosPolicyField::autopurge_disposed_samples_delayFieldName),
		::DDS::Duration_tField::FromCppToJsValue(cppValue.autopurge_disposed_samples_delay));
...
void UserDataQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, UserDataQosPolicyField::New)->GetFunction());
...
Local<Value> UserDataQosPolicyField::FromCppToJsValue(UserDataQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, UserDataQosPolicyField::valueFieldName),
		::DdsJs::UnboundedSeqField< ::DdsJs::OctetField >::FromCppToJsValue(cppValue.value));
...
void HistoryQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, HistoryQosPolicyField::New)->GetFunction());
...
Local<Value> HistoryQosPolicyField::FromCppToJsValue(HistoryQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, HistoryQosPolicyField::kindFieldName),
		::DDS::HistoryQosPolicyKindField::FromCppToJsValue(cppValue.kind));
	result->Set(ctx,
		Local<String>::New(isolate, HistoryQosPolicyField::depthFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.depth));
...
void QosPolicyCountField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, QosPolicyCountField::New)->GetFunction());
...
Local<Value> QosPolicyCountField::FromCppToJsValue(QosPolicyCountField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, QosPolicyCountField::policy_idFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.policy_id));
	result->Set(ctx,
		Local<String>::New(isolate, QosPolicyCountField::countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.count));
...
void PartitionQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, PartitionQosPolicyField::New)->GetFunction());
...
Local<Value> PartitionQosPolicyField::FromCppToJsValue(PartitionQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, PartitionQosPolicyField::nameFieldName),
		::DdsJs::UnboundedSeqField< ::DdsJs::UnboundedStringField >::FromCppToJsValue(cppValue.name));
...
void BuiltinTopicKey_tField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, BuiltinTopicKey_tField::New)->GetFunction());
...
Local<Value> BuiltinTopicKey_tField::FromCppToJsValue(BuiltinTopicKey_tField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, BuiltinTopicKey_tField::valueFieldName),
		::DdsJs::ArrayField< ::DdsJs::LongField, 3 >::FromCppToJsValue(cppValue.value));
...
void OfferedIncompatibleQosStatusField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, OfferedIncompatibleQosStatusField::New)->GetFunction());
...
Local<Value> OfferedIncompatibleQosStatusField::FromCppToJsValue(OfferedIncompatibleQosStatusField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, OfferedIncompatibleQosStatusField::total_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count));
	result->Set(ctx,
		Local<String>::New(isolate, OfferedIncompatibleQosStatusField::total_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count_change));
	result->Set(ctx,
		Local<String>::New(isolate, OfferedIncompatibleQosStatusField::last_policy_idFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.last_policy_id));
	result->Set(ctx,
		Local<String>::New(isolate, OfferedIncompatibleQosStatusField::policiesFieldName),
		::DdsJs::UnboundedSeqField< ::DDS::QosPolicyCountField >::FromCppToJsValue(cppValue.policies));
...
void OwnershipStrengthQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, OwnershipStrengthQosPolicyField::New)->GetFunction());
...
Local<Value> OwnershipStrengthQosPolicyField::FromCppToJsValue(OwnershipStrengthQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, OwnershipStrengthQosPolicyField::valueFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.value));
...
void GroupDataQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, GroupDataQosPolicyField::New)->GetFunction());
...
Local<Value> GroupDataQosPolicyField::FromCppToJsValue(GroupDataQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, GroupDataQosPolicyField::valueFieldName),
		::DdsJs::UnboundedSeqField< ::DdsJs::OctetField >::FromCppToJsValue(cppValue.value));
...
void TopicDataQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, TopicDataQosPolicyField::New)->GetFunction());
...
Local<Value> TopicDataQosPolicyField::FromCppToJsValue(TopicDataQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, TopicDataQosPolicyField::valueFieldName),
		::DdsJs::UnboundedSeqField< ::DdsJs::OctetField >::FromCppToJsValue(cppValue.value));
...
void DomainParticipantQosField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, DomainParticipantQosField::New)->GetFunction());
...
Local<Value> DomainParticipantQosField::FromCppToJsValue(DomainParticipantQosField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, DomainParticipantQosField::user_dataFieldName),
		::DDS::UserDataQosPolicyField::FromCppToJsValue(cppValue.user_data));
	result->Set(ctx,
		Local<String>::New(isolate, DomainParticipantQosField::entity_factoryFieldName),
		::DDS::EntityFactoryQosPolicyField::FromCppToJsValue(cppValue.entity_factory));
...
void OfferedDeadlineMissedStatusField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, OfferedDeadlineMissedStatusField::New)->GetFunction());
...
Local<Value> OfferedDeadlineMissedStatusField::FromCppToJsValue(OfferedDeadlineMissedStatusField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, OfferedDeadlineMissedStatusField::total_countFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count));
	result->Set(ctx,
		Local<String>::New(isolate, OfferedDeadlineMissedStatusField::total_count_changeFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.total_count_change));
	result->Set(ctx,
		Local<String>::New(isolate, OfferedDeadlineMissedStatusField::last_instance_handleFieldName),
		::DdsJs::UnsignedLongField::FromCppToJsValue(cppValue.last_instance_handle));
...
void TransportPriorityQosPolicyField::Init(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(),
		...
		FunctionTemplate::New(isolate, TransportPriorityQosPolicyField::New)->GetFunction());
...
Local<Value> TransportPriorityQosPolicyField::FromCppToJsValue(TransportPriorityQosPolicyField::ConstRefType cppValue)
{
	...
	result->Set(ctx,
		Local<String>::New(isolate, TransportPriorityQosPolicyField::valueFieldName),
		::DdsJs::LongField::FromCppToJsValue(cppValue.value));
...
void InitAll(Local<Object> exports)
{
	...
	exports->Set(isolate->GetCurrentContext(), String::NewFromUtf8(isolate, "DDS"), moduleExports);
